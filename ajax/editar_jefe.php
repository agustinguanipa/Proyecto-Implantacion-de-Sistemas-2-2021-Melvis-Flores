...
// Actualizar Jefe de Familia
	...
	$query_user = mysqli_query($conexion,"UPDATE tab_jef SET nombr_jef='".$nombr_jef."', apeli_jef='".$apeli_jef."',fecna_jef='".$fecna_jef."', telem_jef='".$telem_jef."', telec_jef='".$telec_jef."', email_jef='".$email_jef."', calle_jef='".$calle_jef."', direc_jef='".$direc_jef."', seria_jef='".$seria_jef."', usuar_jef='".$usuar_jef."', contr_jef='".$contr_jef."', ident_tip='".$ident_tip."' WHERE ident_jef='".$id."'");
